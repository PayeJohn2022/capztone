...
import { FaNotesMedical, FaRegCalendarAlt, FaSignOutAlt, FaUserCircle, FaUser, FaClipboard } from 'react-icons/fa';
...
const PediatricianSidebar = () => {
  ...
  const SIDEBAR_LINKS = [
    ...
    { id: 5, path: "/pediatrician/patients", name: "Patients", icon: FaUser },
    { id: 6, path: "/pediatrician/medical-records", name: "Medical Records", icon: FaClipboard },
    { id: 7, path: "/pediatrician/profile", name: "Profile", icon: FaUserCircle },
    { id: 8, path: "/pediatrician/profile", name: "Logout", icon: FaSignOutAlt },
  ];
